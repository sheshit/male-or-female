...
Y_prediction0 = clf.predict(X_test)
...
print("Prediction for decision tree : ",Y_prediction0)

print("Prediction for SUpprt vector classifier : ",Y_prediction1)

print("Prediction for Naive Bayes : ",Y_prediction2)

print("Prediction for k neighbours classifier : ",Y_prediction3)

print("Accuracy for Decision tree : ",accuracy_score(Y_test,Y_prediction2))
